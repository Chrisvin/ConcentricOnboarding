...
/**
 * `ConcentricOnboardingConstraintLayout` is a custom [ConstraintLayout] that implements [ConcentricOnboardingLayout].
 */
open class ConcentricOnboardingConstraintLayout : ConstraintLayout, ConcentricOnboardingLayout {
    ...
    override fun revealForPercentage(percent: Float) {
        ...
        path = clipPathProvider.getPath(percent, this@ConcentricOnboardingConstraintLayout)
        invalidate()
    }
}