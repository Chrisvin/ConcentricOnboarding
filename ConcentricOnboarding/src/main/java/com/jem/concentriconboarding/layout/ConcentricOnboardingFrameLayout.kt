 ...
 */
open class ConcentricOnboardingFrameLayout : FrameLayout, ConcentricOnboardingLayout {
    ...
    override fun revealForPercentage(percent: Float) {
        ...
        path = clipPathProvider.getPath(percent, this@ConcentricOnboardingFrameLayout)
        invalidate()
    }
}